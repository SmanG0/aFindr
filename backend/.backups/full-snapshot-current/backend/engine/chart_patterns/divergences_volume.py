...
from .chart_palette import DIVERGENCE, VOLUME_PROFILE, VOLUME_SPIKE
        ...
        for i in range(1, len(swing_highs)):
            ...
            if sp_curr.price > sp_prev.price and rsi_curr < rsi_prev:
                elements.extend(_make_divergence_elements(
                    ...
                    DIVERGENCE["rsi_bear"]["color"], div_count,
                ))
                div_count += 1
        ...
        for i in range(1, len(swing_highs)):
            ...
            if sp_curr.price < sp_prev.price and rsi_curr > rsi_prev:
                elements.extend(_make_divergence_elements(
                    ...
                    DIVERGENCE["hidden"]["color"], div_count,
                ))
                div_count += 1
        ...
        for i in range(1, len(swing_lows)):
            ...
            if sp_curr.price < sp_prev.price and rsi_curr > rsi_prev:
                elements.extend(_make_divergence_elements(
                    ...
                    DIVERGENCE["rsi_bull"]["color"], div_count,
                ))
                div_count += 1
    ...
    for i in range(1, len(swing_highs)):
        ...
        if sp_curr.price > sp_prev.price and macd_curr < macd_prev:
            elements.extend(_make_divergence_elements(
                ...
                DIVERGENCE["macd"]["color"], div_count,
            ))
            div_count += 1
    ...
    elements: List[ChartElement] = [
        ...
        ChartElement(
            ...
            props={
                ...
                "color": VOLUME_PROFILE["poc"]["color"],
                "width": VOLUME_PROFILE["poc"]["width"],
                "style": VOLUME_PROFILE["poc"]["style"],
        ...
        ChartElement(
            ...
            props={
                "price": round(vah, 2),
                "color": VOLUME_PROFILE["vah_val"]["color"],
                "width": VOLUME_PROFILE["vah_val"]["width"],
                "style": VOLUME_PROFILE["vah_val"]["style"],
                "label": f"VAH {vah:.2f}",
            },
        ),
        # VAL line
        ...
        ChartElement(
            ...
            props={
                ...
                "color": VOLUME_PROFILE["area_box"]["color"],
                "opacity": VOLUME_PROFILE["area_box"]["opacity"],
...
def detect_volume_spikes(
    ...
    for i in range(avg_period, n):
        ...
        if ratio >= volume_threshold:
            ...
            color = VOLUME_SPIKE["bull"]["color"] if is_bullish else VOLUME_SPIKE["bear"]["color"]

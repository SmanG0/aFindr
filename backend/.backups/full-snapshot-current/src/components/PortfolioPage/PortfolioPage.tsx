...
export default function PortfolioPage({ accountState, currentPrice, onNavigateToChart, onPageChange, onOpenSettings }: PortfolioPageProps) {
        ...
        {selectedTicker === null ? (
          ...
          >
            <StockDetailView
              ...
              position={accountState.positions.find(p => p.symbol === selectedTicker)}
            />
            {/* Right column: padded so the card floats with margin */}
            <div style={{ padding: 16, flexShrink: 0 }}>
              <OrderPanel

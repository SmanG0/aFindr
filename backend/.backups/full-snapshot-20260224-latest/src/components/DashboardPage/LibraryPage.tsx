                          ...
                          return (
                            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                              ...
                              <div style={{
                                ...
                                borderLeft: `3px solid ${APPROACH_TAG_COLORS[profile.approachTag]}`,
                                background: `${APPROACH_TAG_COLORS[profile.approachTag]}08`,
                              }}>
                                <div style={{
                                  fontSize: 10, fontFamily: "var(--font-mono)", fontWeight: 700,
                                  color: APPROACH_TAG_COLORS[profile.approachTag],
                                ...
                                <div style={{ fontSize: 13, lineHeight: 1.5, color: "var(--text-primary)", fontWeight: 500 }}>
                                  {profile.famousFor}
                                </div>
                              </div>
                            </div>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                  {profile.keyMetrics.map((metric, i) => (
                                    <div key={i} style={{
                                      ...
                                      background: `${APPROACH_TAG_COLORS[profile.approachTag]}06`,
                                      border: `1px solid ${APPROACH_TAG_COLORS[profile.approachTag]}12`,
                                    }}>
                                      <div style={{
                                        width: 6, height: 6, borderRadius: "50%",
                                        background: APPROACH_TAG_COLORS[profile.approachTag],
                                        flexShrink: 0,
                                      }} />
                                      <div style={{

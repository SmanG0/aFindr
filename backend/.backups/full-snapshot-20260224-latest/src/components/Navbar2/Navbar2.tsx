    ...
    >
        ...
        <AnimatePresence mode="popLayout">
          {!tradeExpanded && (
            <motion.button
              ...
              onClick={() => !tradingDisabled && setTradeExpanded(true)}
              ...
              style={{
                ...
                padding: "0 12px",
                height: 30,
                cursor: tradingDisabled ? "not-allowed" : "pointer",
                color: "var(--text-secondary)",
                fontSize: 11,
                fontWeight: 600,
                whiteSpace: "nowrap",
                opacity: tradingDisabled ? 0.5 : 1,
              }}
              onMouseEnter={e => { if (!tradingDisabled) e.currentTarget.style.background = "rgba(236,227,213,0.1)"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "rgba(236,227,213,0.06)"; }}
              title={tradingDisabled ? "Activate paper trading first" : "Show trade buttons (Ctrl+A)"}
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {tradeExpanded && (
            ...
            >
              {/* SELL */}
              <button
                onClick={() => !tradingDisabled && onSell(currentPrice - spread / 2)}
                disabled={tradingDisabled}
                style={{
                  background: tradingDisabled ? "rgba(236,227,213,0.06)" : "linear-gradient(135deg, var(--sell), hsl(0 65% 42%))",
                  color: tradingDisabled ? "var(--text-disabled)" : "white",
                  border: "none",
                  borderRadius: 8,
                  padding: "0 14px",
                  height: 30,
              ...
              {/* BUY */}
              <button
                onClick={() => !tradingDisabled && onBuy(currentPrice + spread / 2)}
                disabled={tradingDisabled}
                style={{
                  background: tradingDisabled ? "rgba(236,227,213,0.06)" : "linear-gradient(135deg, var(--buy), hsl(163 70% 32%))",
                  color: tradingDisabled ? "var(--text-disabled)" : "white",
                  border: "none",
                  borderRadius: 8,
                  padding: "0 14px",
      ...
      {onOpenJournal && (
        <button
          ...
          className="flex items-center gap-1.5"
          style={{
            background: showJournal ? "rgba(236,227,213,0.14)" : "rgba(236,227,213,0.06)",
            border: `1px solid ${showJournal ? "rgba(236,227,213,0.2)" : "rgba(236,227,213,0.1)"}`,
            borderRadius: 20,
            padding: "0 12px",
            height: 30,
            cursor: "pointer",
          ...
          onMouseEnter={e => { if (!showJournal) e.currentTarget.style.background = "rgba(236,227,213,0.1)"; }}
          onMouseLeave={e => { if (!showJournal) e.currentTarget.style.background = "rgba(236,227,213,0.06)"; }}
          title={showJournal ? "Close Journal" : "Open Journal"}
        >

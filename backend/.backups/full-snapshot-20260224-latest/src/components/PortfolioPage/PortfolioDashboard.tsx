...
// Dev-only demo holdings — 5 stocks + 2 crypto, realistic purchase dates
const DEMO_HOLDINGS: Holding[] = [
  { _id: "demo-1", symbol: "AAPL",    shares: 15, avgCostBasis: 178.50, addedAt: Date.now() - 120 * 86400000, purchaseDate: Date.now() - 120 * 86400000 },
  { _id: "demo-2", symbol: "NVDA",    shares: 8,  avgCostBasis: 620.00, addedAt: Date.now() - 90  * 86400000, purchaseDate: Date.now() - 90  * 86400000 },
  { _id: "demo-3", symbol: "MSFT",    shares: 12, avgCostBasis: 355.00, addedAt: Date.now() - 200 * 86400000, purchaseDate: Date.now() - 200 * 86400000 },
  { _id: "demo-4", symbol: "GOOGL",   shares: 10, avgCostBasis: 140.00, addedAt: Date.now() - 60  * 86400000, purchaseDate: Date.now() - 60  * 86400000 },
  { _id: "demo-5", symbol: "TSLA",    shares: 5,  avgCostBasis: 245.00, addedAt: Date.now() - 45  * 86400000, purchaseDate: Date.now() - 45  * 86400000 },
  { _id: "demo-6", symbol: "BTC-USD", shares: 0.35, avgCostBasis: 42000, addedAt: Date.now() - 150 * 86400000, purchaseDate: Date.now() - 150 * 86400000 },
  { _id: "demo-7", symbol: "ETH-USD", shares: 4,   avgCostBasis: 2200,  addedAt: Date.now() - 100 * 86400000, purchaseDate: Date.now() - 100 * 86400000 },
];
...
export default function PortfolioDashboard({
  ...
  useEffect(() => {
    let cancelled = false;
    fetchBenchmarkChart(activePeriod === "ALL" ? "5Y" : activePeriod)

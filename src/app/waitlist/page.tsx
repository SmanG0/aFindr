...
const QUICK_QUESTIONS: { label: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer: "We're putting the finishing touches on the platform right now. Join the waitlist and you'll be the first to know when we go live. Early waitlisters get priority access and exclusive perks!",
  },
  {
  ...
  {
    label: "Is it free?",
    answer: "aFindr will be free to get started \u2014 you'll get access to charting, AI analysis, and paper trading. We connect to 7 CMA-regulated brokers so when you're ready to go live, everything is already set up.",
  },
  {
    label: "What markets?",
    answer: "We're launching with full support for the Nairobi Securities Exchange (NSE). Expanding to USE (Uganda), DSE (Tanzania), RSE (Rwanda), and JSE (South Africa). You can also analyze global futures, forex, and crypto.",
  },
  {
    label: "How do I fund?",
  ...
  return (
    ...
    >
      ...
      {remaining.length === 0 && !isTyping && (
        <div className="wl-alphy-chat-chips">
          <button
            className="wl-alphy-chip wl-alphy-chip-cta"
            onClick={onClose}
          >
  ...
  return (
    <div className="wl-page">
      ...
      <section className="wl-cta-section">
        ...
        <Reveal delay={0.05}>
          <h2 className="wl-cta-heading" style={{ marginTop: 24 }}>Don&apos;t miss the launch.</h2>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="wl-cta-subtext">Be among the first Kenyan traders to use AI to find their edge.</p>
        </Reveal>
        <Reveal delay={0.2}>

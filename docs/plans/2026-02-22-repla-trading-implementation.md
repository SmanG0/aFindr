# Repla Trading Platform Implementation Plan
...
Replace the default globals.css with Repla-style dark theme:
...
export default function Home() {
  return (
    <div className="flex items-center justify-center h-screen">
      <h1 className="text-2xl font-mono text-white/50">Repla Trading</h1>
    </div>
  );
}
```

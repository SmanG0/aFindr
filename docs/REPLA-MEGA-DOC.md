# Repla / αFindr — Complete Platform Documentation
...
# Part 1: Core Design — Repla Trading Platform
...
- `.panel-border-top/bottom` — 0.667px Repla-style borders

## Borders

Repla uses ultra-thin `0.667px` borders.
